...
HD_PWD='C:/Users/Diego Lemus/Desktop/UNIS/Semestre 6/MICRO/Parcial3-Microcontroladores/FMS_Clk_Basys3/FMS_Clk_Basys3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VivePass.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VivePass.tcl -notrace
