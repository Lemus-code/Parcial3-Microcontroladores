...
HD_PWD='C:/Users/Diego Lemus/Desktop/UNIS/Semestre 6/MICRO/Parcial3-Microcontroladores/FMS_Clk_Basys3/FMS_Clk_Basys3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VivePass.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VivePass.tcl
